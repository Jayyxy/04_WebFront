...
// 2개의 값을 전달받아 콘솔로 단순 출력하는 기능이 함수
...
btn1.addEventListener("click", function(){
  ...
  print1(value, result);
  // 중요* 전달되는 전달인자 값의 순서 유의 ! : print1(result, value); 불가
...
arrowList[2].addEventListener("click", () => {
  ...
  // twoNumberPlus((a,b) => {return a+b} ; 와 동일 
  // return과 중괄호 생략 가능 

});

// return이 한 줄인데 object 반환하는 경우
